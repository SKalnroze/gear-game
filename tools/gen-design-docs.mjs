...
function buildBlocks(m) {
  ...
  blocks['world.constants'] = table(
    ...
    [
      ...
      w('PLAY_Y_MIN', 'top of the playable band -- the whole arena, no lane'),
      w('PLAY_Y_MAX', 'bottom of the playable band'),
      w('SPAWN_Y_MARGIN', 'keeps a spawned unit clear of the arena edge'),
