...
export const TECH_NODES: Record<string, TechNode> = {
  ...
  unlock_crystal_mining: {
    ...
    description: 'Unlocks the Crystal Miner gear. Generates crystal per rotation.',
    tier: 2, goldCost: 50, researchTime: 45000,
    prereqs: ['unlock_iron_mining'],
  ...
  unlock_aether_mining: {
    ...
    description: 'Unlocks the Aether Miner gear. Generates aether per rotation.',
    tier: 3, goldCost: 100, researchTime: 75000,
    prereqs: ['unlock_crystal_mining'],
